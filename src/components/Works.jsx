...
const ProjectCard = ({
  ...
  const displayLink = live_demo !== "" ? true : false;
    ...
    <>
      ...
      <div className='w-full flex'>
        ...
        >
          ...
          des travaux concrets. Chaque projet est brièvement décrit avec
          des liens vers des référentiels de code et des démonstrations en direct quand cela est possible.
          Les technologies utilisées sont également listées.
        </motion.p>
      </div>
